...
example_alphabet = ['a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't',
                    'u', 'v', 'w', 'x', 'y', 'z']
...
def generate_examples_for_word(word="dog", number_of_examples=100, poelap=0.03, poelenl=0.7, powlap=0.1, polmap=0.01,
...
def generate_examples_for_words(words=default_word_list, number_of_examples=100, poelap=0.03, poelenl=0.7, powlap=0.1,
                                polmap=0.01, alphabet=example_alphabet):
    '''
    ...
    for word in words:
        word_training_example_tuples.append(
            (word, generate_examples_for_word(word, number_of_examples, poelap, poelenl, powlap, polmap, alphabet)))
